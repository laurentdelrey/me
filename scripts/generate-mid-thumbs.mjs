...
// 640px medium thumbnails for /cloud, where cards render ~230px CSS on a
// 2x display. Stored alongside the 200px filmstrip thumbs as "-mid.jpg".
...
function thumbKey(media, kind) {
  ...
  return `tweets/thumbs/${base}-mid.jpg`;
}
